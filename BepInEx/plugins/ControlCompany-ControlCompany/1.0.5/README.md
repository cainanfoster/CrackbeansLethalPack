...
## Mod TL;DR
Credits to [**TheViperian**](https://www.youtube.com/@TheViperian) for creating a comprehensive video tutorial showcasing the mod, its features and controls! :)

![tutorial_video](https://www.youtube.com/watch?v=NMo9odDjmyM)
...
- Rolled back changes to Hoarding Bug in v1.0.4 was causing sync issues. Investigating issue.
